		...
		<div class="content">
			<section class="first">
				<div class="central">
					...
					<div class="labels">
						<h3>Cadastre facilmente seus produtos</h3>
						<h3>Direcione seu público alvo e atinja somente quem deseja comprar</h3>
						<h3>Acompanhe relatórios, gráficos e todos os dados relevantes de seus produtos</h3>
					</div>
			...
			<section class="third">
				<div class="central">
					...
					<h2>Algumas lojas que já se cadastraram</h2>
	...
	<script>	
		...
		function carregaShoppings(){
			...
			$.ajax({type:'GET', dataType:'json', url:servidor+'getcidadescomshoppings', timeout:timeout,
				...
				error: function(){			
					console.warn("Erro ao carregar cidades ");
				}
			});
		}
